          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-base-content/60">
                Better booking. Stronger venue operations.
              </p>
            </div>
          </div>
          <p className="mt-4 max-w-md text-sm leading-7 text-base-content/65">
            PlayRizon brings player discovery, owner workflows, and platform
            visibility together under one sharper sports-booking experience.
          </p>
        </div>
